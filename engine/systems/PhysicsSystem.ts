...
export class PhysicsSystem {
  ...
  static handleCollisions(
    ...
    // ULTRA OPTIMIZED: Using Grid for CCD to prevent lag spikes with many bullets
    for (const bullet of entities) {
        ...
        // Query near neighbors instead of ALL entities
        const nearTargets = this.grid.query(bullet.pos);
